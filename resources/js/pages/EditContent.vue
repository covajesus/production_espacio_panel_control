                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-4">
                                                ...
                                                >
                                                <br>
                                                <ColorPicker :color="`${color}`" @color-change="updateColor" :visible-formats="['rgb']" />
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-4" v-if="this.georeferencing_type_input == 1">
                                                ...
                                                >
                                                    <option :selected="commune_input === ''" value="">Todas las comunas</option>
                                                    <option :selected="commune_input === commune_post.id" v-for="commune_post in commune_posts" :key="commune_post.id" :value="commune_post.id">{{ commune_post.commune }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
    ...
    methods: {
        ...
        async getSelectedRegionsCommunes() {
            ...
            if(token) {
                ...
                try {
                    const response = await axios.get(
                    "https://paneldecontrolem.cl/api/content_commune/" + this.$route.params.id,
                    {
                        headers: {
                        accept: "application/json",
                        Authorization: `Bearer ${token}`,
            ...
            if(token) {
                ...
                try {
                    const response = await axios.post(
                        "https://paneldecontrolem.cl/api/content/" + this.$route.params.id,
                        formData,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
        ...
        async getData() {
            ...
            if(token) {
                ...
                try {
                    const response = await axios.get(
                        "https://paneldecontrolem.cl/api/content_region/" + this.$route.params.id,
                        {
                            headers: {
                                accept: "application/json",
                                Authorization: `Bearer ${token}`,
